...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Shadow Line Detailing" },
      { name: "description", content: "პროფესიონალური პოლირება, კერამიკული დაფარვა და სალონის დეტეილინგი თბილისში. Shadow Line — შედეგი, რომელიც ჩანს." },
      { name: "author", content: "Shadow Line Detailing" },
      { property: "og:title", content: "Shadow Line Detailing" },
      { property: "og:description", content: "პროფესიონალური პოლირება, კერამიკული დაფარვა და სალონის დეტეილინგი თბილისში. Shadow Line — შედეგი, რომელიც ჩანს." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Shadow Line Detailing" },
      { name: "twitter:description", content: "პროფესიონალური პოლირება, კერამიკული დაფარვა და სალონის დეტეილინგი თბილისში. Shadow Line — შედეგი, რომელიც ჩანს." },
