...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Shadow Line Detailing — პრემიუმ ავტო დეტეილინგი თბილისში" },
      ...
      { property: "og:title", content: "Shadow Line Detailing — პრემიუმ ავტო დეტეილინგი" },
      { property: "og:description", content: "პოლირება, კერამიკული დაფარვა და სალონის დეტეილინგი თბილისში." },
